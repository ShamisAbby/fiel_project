<?php
  ...
  $sql = "SELECT * FROM Child_info WHERE status = 1";
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          <li><a href="new_child.php" class="nav-link scrollto"><i class="bi bi-file-earmark-check"></i> <span>New</span></a></li>
          <li><a href="#" class="nav-link scrollto active"><i class="bx bx-user"></i> <span>confirmed</span></a></li>
